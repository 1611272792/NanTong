...
function GetLoadNav() {
    ...
    $.each(data, function (i) {
        ...
        if (row.p_id == 0) {
           ...
           // _html += '<a data-id="' + row.AuthorId + '" href="#" class="dropdown-toggle"><i class="' + row.F_Icon + '"></i><span>' + row.AuthorName + '</span><i class="fa fa-angle-right drop-icon"></i></a>';
            
            _html += '<a data-id="' + row.AuthorId + '" href="#" class="dropdown-toggle"><img style="width:20px;height:20px;" src="../Content/Icon/' + row.image + '"><span>' + row.AuthorName + '</span><i class="fa fa-angle-right drop-icon"></i></a>';
            ...
            if (childNodes.length > 0) {
                ...
                $.each(childNodes, function (i) {
                    ...
                    _html += '<li>';
                    _html += '<a class="menuItem" data-id="' + subrow.AuthorId + '" href="' + subrow.url + '" data-index="' + subrow.F_SortCode + '">' + subrow.AuthorName + '</a>';
                    _html += '</li>';
                });
                _html += '</ul>';
            }
