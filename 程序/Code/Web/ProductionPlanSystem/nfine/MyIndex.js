...
function GetLoadNav() {
    ...
    _html += '<li>';
    _html += '<a data-id="11" href="#" class="dropdown-toggle"><i class="fa fa-gears"></i><span>系统管理</span><i class="fa fa-angle-right drop-icon"></i></a>';
    _html += '<ul class="submenu">';
    $.each(data, function (i) {
        var subrow = data[i];
        _html += '<li>';
        _html += '<a class="menuItem" data-id="' + subrow.menuID + '" href="' + subrow.menuUrl + '">' + subrow.menuName + '</a>';
        _html += '</li>';
    });
    _html += '</ul>';
    _html += '</li>';
