...
namespace ProductionPlanSystem.Controllers
{
    public class SizeController : Controller
    {
        ...
        /// <returns></returns>
        public string GetUpdSizeInfo(string PSNo)
        {
        ...
        [HttpGet]
        public ActionResult SelectAll(string SizeName, string ProductName,string pagecount, string size)
        {
            //分页
            string mysqls = "";//总数据
            mysqls = string.Format($"EXEC dbo.[proc_Size] @strType='SelectAll',@ProductSizeName='{SizeName}',@ProductName='{ProductName}',@pagecount={pagecount},@size={size}");
